...
### Compiler
You can create your own compiler for each and every css properties or add new peoperties by extending the current 
configuration file.
```js file="aliasccs.config.js"
export config={
...
```jsx filr="Button.tsx" showLineNumbers
